...
val electronicsList = listOf(
    ...
    CategoriesItems(R.drawable.ic_home_kitchen, "Laptop"),
    CategoriesItems(R.drawable.ic_beauty_care, "Microphone"),
    CategoriesItems(R.drawable.ic_shoes_jewelry, "Digital Camera"),
    CategoriesItems(R.drawable.ic_toys_games, "Smart Watch"),
    CategoriesItems(R.drawable.ic_health_baby_care, "Portable Speaker"),
    CategoriesItems(R.drawable.ic_cell_accessories, "TV"),
    CategoriesItems(R.drawable.ic_sports_outdoors, "Home Theater"),
    CategoriesItems(R.drawable.ic_pet_supplies, "Earbud"),
    CategoriesItems(R.drawable.ic_office, "Tablet"),
    CategoriesItems(R.drawable.ic_tools, "Security Camera"),
    CategoriesItems(R.drawable.ic_baby_products, "Drone"),
    CategoriesItems(R.drawable.ic_grocery_gourmet, "Grocery & Gourmet"),
    CategoriesItems(R.drawable.ic_automotive, "Automotive"),
    CategoriesItems(R.drawable.ic_musical_instruments, "Musical Instruments"),
    CategoriesItems(R.drawable.ic_luggage, "Luggage & Travel Gear"),
...
val HealthList = listOf(
    CategoriesItems(R.drawable.ic_electronics, "Laser"),
...
val PetSuppliesList = listOf(
    CategoriesItems(R.drawable.ic_electronics, "Dog"),
    CategoriesItems(R.drawable.ic_electronics, "Cat"),
    CategoriesItems(R.drawable.ic_electronics, "Fish"),
)
